...
import org.openurp.prac.activity.model.AbstractPracSchedule
...
object DateTable {
  ...
  def apply(from: LocalDate, to: LocalDate, datas: collection.Map[LocalDate, collection.Seq[AbstractPracSchedule]]): Iterable[DateTable] = {
...
case class DateTable(date: LocalDate, schedules: Iterable[AbstractPracSchedule]) {
