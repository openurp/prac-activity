...
import org.openurp.prac.activity.model.StdPracticeInfo
import org.openurp.starter.web.support.ProjectSupport

class StdPracticeInfoAction extends RestfulAction[StdPracticeInfo], ProjectSupport, ExportSupport[StdPracticeInfo] {
