...
abstract class AbstractSchedule extends LongId with DateRange with Remark {
  ...
  def mergeWith(ns: AbstractSchedule): Unit = {
    val nwt = ns.weekTime
  ...
  def copyOn(newTime: WeekTime): AbstractSchedule = {
